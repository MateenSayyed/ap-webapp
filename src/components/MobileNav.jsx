...
const MobileNav = ({ isMenu, toggleMenu }) => {
  return (
    <div className={styles.container}>
        ...
        <div className={styles.donateBtn}>
          ...
          >
            <path
              ...
              stroke-width="2.505"
              d="M14.817 26.617s1.154-6.985 1.653-10.515 4.42-3.027 4.42 0V29.33q-.348 5.79-7.254 7.917l-2.684 2.881 1.995 2.013L10.952 44 2 35.121l5.769-5.79 1.265-10.383Q14.892 6.599 16.47 3.625C18.05.652 21.158 1.598 20.19 7.8l-.904 5.944m-7.798 26.87-7.385-7.071m8.968 4.201L6.932 31.33m21.25-4.713s-1.153-6.985-1.652-10.515c-.5-3.53-4.42-3.027-4.42 0V29.33q.348 5.79 7.254 7.917l2.684 2.881-1.995 2.013L32.048 44 41 35.121l-5.769-5.79-1.265-10.383Q28.108 6.599 26.53 3.625C24.95.652 21.842 1.598 22.81 7.8l.904 5.944m7.798 26.87 7.385-7.071m-8.968 4.201 6.139-6.415"
            ></path>
          </svg>{" "}
          Donate
        </div>
      ...
      <div className={styles.downImgCont}>
      ...
      <span className={styles.label}>For English</span>
      ...
      <span className={styles.label}>For Hindi</span>
      <div className={styles.socialWrap}>
        <a className={styles.link} href="#">
          <svg
            xmlns="http://www.w3.org/2000/svg"
